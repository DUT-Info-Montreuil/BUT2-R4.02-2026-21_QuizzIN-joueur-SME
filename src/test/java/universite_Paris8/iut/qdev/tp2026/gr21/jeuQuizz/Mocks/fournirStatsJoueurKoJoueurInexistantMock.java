...
public class fournirStatsJoueurKoJoueurInexistantMock implements IJoueurService {
    ...
    public List<Object> fournirStatsJoueur(String pseudo) throws AucunJoueurEnregistreException {
        throw new AucunJoueurEnregistreException("ERROR : le joueur " + pseudo + " n'existe pas.");
    }
}
